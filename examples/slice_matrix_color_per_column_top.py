# Example script to create a slice matrix with color bar for each column and text annotations in first row
...
if __name__ == '__main__':
    ...
    # Create color map for each column
    ...
    # Create slice matrix with color bars per column and text annotations on the top
    ...
    # Store render as png
    exporter.save_snapshot(filename="slice_matrix_color_per_column_top")