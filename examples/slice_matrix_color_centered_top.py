# Example script to create a slice matrix with centered color bar and text annotations in first row
...
if __name__ == '__main__':
    ...
    text_first_row = ["first column", "second column"]
    ...
    # Define height of the slices in pixels
    height_slice = 520
    ...
    # Create slice matrix with one centered color bar and text annotations in the first row
    ...
    # Store render as png
    exporter.save_snapshot(filename="slice_matrix_color_centered_top")