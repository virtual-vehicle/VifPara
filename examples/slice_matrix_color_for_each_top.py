# Example script to create a slice matrix with color bars for each slice and text annotations in the first row
...
if __name__ == '__main__':
    ...
    # Store render as png
    exporter.save_snapshot(filename="slice_matrix_color_for_each_top")