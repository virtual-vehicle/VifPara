# Example script for saving slices at all timesteps with a time annotation
...
if __name__ == '__main__':
    ...
    # Add time annotation to slice
    annotate_time(view_object=slice_obj)
    ...
    exporter.save_at_all_timesteps(filename="save_slices_time_annot")
