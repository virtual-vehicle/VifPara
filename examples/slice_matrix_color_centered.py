# Example script to create a slice matrix with one centered color bar
...
if __name__ == '__main__':
    ...
    # Create slice matrix with one centered color bar
    ...
    # Store render as png
    exporter.save_snapshot(filename="slice_matrix_color_centered")
